...
global.func = (await import('./system/func/function.js'))
...
setInterval(async () => {
    ...
    conn.reply(info.nomerown + '@s.whatsapp.net', 'Sessions have been cleared', null) >
...
setInterval(async () => {
    ...
    await clearTmp();
    conn.reply(info.nomerown + '@s.whatsapp.net', 'Tmp has been cleared', null) >
        console.log(chalk.cyanBright(
            `\n╭───────────────────·»\n│\n` +
